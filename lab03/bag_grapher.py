...
class Grapher(Node):
    ...
    def __init__(self):
        ...
        #self.declare_parameter("follower_topic", "/vesc/high_level/input/nav_0")
        #self.declare_parameter("safety_topic", "/vesc/input/safety")
        self.declare_parameter("distance_topic", "/dist")
    ...
    def scan_callback(self, received):
        """
